...
| 7.7.3 | Method by which a user delivers a goal | REPL queries, a `?- Goal.` query in the source, CLI `--goal`, `%% ?-` host comments, and the JavaScript `goal` option are supported host interfaces. | **defined** — Chapter 40. |
