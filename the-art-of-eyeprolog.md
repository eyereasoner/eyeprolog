...
[examples/output](https://github.com/eyereasoner/eyeprolog/tree/main/examples/output/), and **102 selected programs** have a checked
...
Run all 235 normal answer goldens and the 102 selected proof goldens with:
...
Separate exact-output suites check 235 normal examples and 102 proof examples; all executable chapter programs are parsed and their declared goals are executed. The nine-case
