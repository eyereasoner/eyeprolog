...
why(1, ['X0' = diamondProperty, 'X1' = r], [holdsFor(diamondProperty, r)]).
answer(1, ['X0' = diamondProperty, 'X1' = re]).
why(1, ['X0' = diamondProperty, 'X1' = re], [holdsFor(diamondProperty, re)]).
query(2, commonSuccessor(_0, _1), ['X0' = _0, 'X1' = _1]).
result(2, complete, 1).
answer(2, ['X0' = diamondProperty, 'X1' = d]).
why(2, ['X0' = diamondProperty, 'X1' = d], [commonSuccessor(diamondProperty, d)]).
query(3, preservedUnderReflexiveClosure(_0, _1), ['X0' = _0, 'X1' = _1]).
result(3, complete, 1).
answer(3, ['X0' = diamondProperty, 'X1' = true]).
why(3,
    ['X0' = diamondProperty, 'X1' = true],
