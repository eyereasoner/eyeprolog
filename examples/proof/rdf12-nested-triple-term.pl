...
clause(2,
       ...
       rdf(anonymous(1), iri('https://example.org/reviews'), triple(anonymous(2), iri('https://example.org/claims'), triple(var('S'), iri('https://example.org/knows'), var('O'))), var('G'))).
...
step(result_rdf(iri('https://example.org/bob'), iri('https://example.org/knows'), iri('https://example.org/carol'), default_graph),
     ...
     ['S' = iri('https://example.org/bob'),
      ...
      'G' = default_graph],
     [rdf(iri('https://example.org/auditor'), iri('https://example.org/reviews'), triple(iri('https://example.org/alice'), iri('https://example.org/claims'), triple(iri('https://example.org/bob'), iri('https://example.org/knows'), iri('https://example.org/carol'))), default_graph)]).
step(rdf(iri('https://example.org/auditor'), iri('https://example.org/reviews'), triple(iri('https://example.org/alice'), iri('https://example.org/claims'), triple(iri('https://example.org/bob'), iri('https://example.org/knows'), iri('https://example.org/carol'))), default_graph),
     fact(1),
     [],
     []).
