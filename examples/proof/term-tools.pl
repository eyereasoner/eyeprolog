...
result(1, complete, 6).
answer(1, ['X0' = shape, 'X1' = shape(edge, 3)]).
why(1, ['X0' = shape, 'X1' = shape(edge, 3)], [report(shape, shape(edge, 3))]).
answer(1, ['X0' = second_argument, 'X1' = b]).
why(1, ['X0' = second_argument, 'X1' = b], [report(second_argument, b)]).
answer(1, ['X0' = parts, 'X1' = parts(edge, [a, b, 3])]).
why(1, ['X0' = parts, 'X1' = parts(edge, [a, b, 3])], [report(parts, parts(edge, [a, b, 3]))]).
answer(1, ['X0' = rebuilt, 'X1' = edge(c, d, 5)]).
why(1, ['X0' = rebuilt, 'X1' = edge(c, d, 5)], [report(rebuilt, edge(c, d, 5))]).
answer(1, ['X0' = rendered, 'X1' = 'edge(a, [b, c])']).
why(1, ['X0' = rendered, 'X1' = 'edge(a, [b, c])'], [report(rendered, 'edge(a, [b, c])')]).
answer(1, ['X0' = all_weights_positive, 'X1' = yes]).
why(1, ['X0' = all_weights_positive, 'X1' = yes], [report(all_weights_positive, yes)]).
