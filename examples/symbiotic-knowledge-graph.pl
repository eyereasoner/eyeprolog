...
rdf(iri('https://example.org/city/facility/central-hall'), iri('https://example.org/vocab/kind'), iri('https://example.org/city/class/cooling-center'), iri('https://example.org/graph/city-facilities')).
rdf(iri('https://example.org/city/facility/central-hall'), iri('https://example.org/vocab/neighbourhood'), iri('https://example.org/city/neighbourhood/central'), iri('https://example.org/graph/city-facilities')).
...
rdf(iri('https://example.org/city/facility/central-hall'), iri('https://example.org/vocab/cooling'), iri('https://example.org/city/state/available'), iri('https://example.org/graph/city-facilities')).
rdf(iri('https://example.org/city/facility/central-hall'), iri('https://example.org/vocab/capacity'), literal('140', datatype('http://www.w3.org/2001/XMLSchema#integer')), iri('https://example.org/graph/city-facilities')).
rdf(iri('https://example.org/city/facility/central-hall'), iri('https://example.org/vocab/wheelchairAccess'), iri('https://example.org/city/value/yes'), iri('https://example.org/graph/city-facilities')).
rdf(iri('https://example.org/city/facility/north-library'), iri('https://example.org/vocab/kind'), iri('https://example.org/city/class/cooling-center'), iri('https://example.org/graph/city-facilities')).
rdf(iri('https://example.org/city/facility/north-library'), iri('https://example.org/vocab/neighbourhood'), iri('https://example.org/city/neighbourhood/north'), iri('https://example.org/graph/city-facilities')).
rdf(iri('https://example.org/city/facility/north-library'), iri('https://example.org/vocab/status'), iri('https://example.org/city/state/open'), iri('https://example.org/graph/city-facilities')).
rdf(iri('https://example.org/city/facility/north-library'), iri('https://example.org/vocab/cooling'), iri('https://example.org/city/state/available'), iri('https://example.org/graph/city-facilities')).
rdf(iri('https://example.org/city/facility/north-library'), iri('https://example.org/vocab/capacity'), literal('80', datatype('http://www.w3.org/2001/XMLSchema#integer')), iri('https://example.org/graph/city-facilities')).
rdf(iri('https://example.org/city/facility/north-library'), iri('https://example.org/vocab/wheelchairAccess'), iri('https://example.org/city/value/yes'), iri('https://example.org/graph/city-facilities')).
rdf(iri('https://example.org/city/facility/riverside-school'), iri('https://example.org/vocab/kind'), iri('https://example.org/city/class/school'), iri('https://example.org/graph/city-facilities')).
...
rdf(iri('https://example.org/city/route/7'), iri('https://example.org/vocab/connects'), iri('https://example.org/city/facility/north-library'), iri('https://example.org/graph/transit-plan')).
rdf(iri('https://example.org/city/route/8'), iri('https://example.org/vocab/connects'), iri('https://example.org/city/facility/central-hall'), iri('https://example.org/graph/transit-plan')).
...
rdf(iri('https://example.org/city/route/8'), iri('https://example.org/vocab/status'), iri('https://example.org/city/state/running'), iri('https://example.org/graph/transit-plan')).
rdf(iri('https://example.org/city/facility/central-hall'), iri('https://example.org/vocab/power'), iri('https://example.org/city/state/unstable'), iri('https://example.org/graph/power-sensors')).
...
rdf(iri('https://example.org/city/evidence/transit-api-20260827'), iri('https://example.org/vocab/publisher'), iri('https://example.org/city/publisher/city-transit'), iri('https://example.org/graph/evidence-registry')).
rdf(iri('https://example.org/city/evidence/facilities-bulletin-20260827'), iri('https://example.org/vocab/evidenceKind'), iri('https://example.org/city/evidence-kind/official-document'), iri('https://example.org/graph/evidence-registry')).
rdf(iri('https://example.org/city/evidence/facilities-bulletin-20260827'), iri('https://example.org/vocab/publisher'), iri('https://example.org/city/publisher/city-facilities'), iri('https://example.org/graph/evidence-registry')).
rdf(iri('https://example.org/city/evidence/community-post-4812'), iri('https://example.org/vocab/evidenceKind'), iri('https://example.org/city/evidence-kind/public-report'), iri('https://example.org/graph/evidence-registry')).
rdf(iri('https://example.org/city/evidence/community-post-4812'), iri('https://example.org/vocab/publisher'), iri('https://example.org/city/publisher/resident-network'), iri('https://example.org/graph/evidence-registry')).
rdf(iri('https://example.org/city/evidence/volunteer-message-112'), iri('https://example.org/vocab/evidenceKind'), iri('https://example.org/city/evidence-kind/public-report'), iri('https://example.org/graph/evidence-registry')).
rdf(iri('https://example.org/city/evidence/volunteer-message-112'), iri('https://example.org/vocab/publisher'), iri('https://example.org/city/publisher/volunteer-coordinator'), iri('https://example.org/graph/evidence-registry')).
