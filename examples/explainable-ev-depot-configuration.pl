...
rdf(iri('https://example.org/ev-depot/site/depot-a'), iri('https://example.org/vocab/supply'), iri('https://example.org/ev-depot/supply/three-phase'), iri('https://example.org/ev-depot/graph/site')).
rdf(iri('https://example.org/ev-depot/charger/fleet22'), iri('https://example.org/vocab/chargeKw'), literal('22', datatype('http://www.w3.org/2001/XMLSchema#integer')), iri('https://example.org/ev-depot/graph/catalog')).
rdf(iri('https://example.org/ev-depot/charger/fleet22'), iri('https://example.org/vocab/sitePowerRequirementKw'), literal('45', datatype('http://www.w3.org/2001/XMLSchema#integer')), iri('https://example.org/ev-depot/graph/catalog')).
rdf(iri('https://example.org/ev-depot/charger/fleet22'), iri('https://example.org/vocab/connector'), iri('https://example.org/ev-depot/connector/ccs2'), iri('https://example.org/ev-depot/graph/catalog')).
rdf(iri('https://example.org/ev-depot/charger/fleet22'), iri('https://example.org/vocab/supply'), iri('https://example.org/ev-depot/supply/three-phase'), iri('https://example.org/ev-depot/graph/catalog')).
rdf(iri('https://example.org/ev-depot/charger/rapid50'), iri('https://example.org/vocab/chargeKw'), literal('50', datatype('http://www.w3.org/2001/XMLSchema#integer')), iri('https://example.org/ev-depot/graph/catalog')).
...
rdf(iri('https://example.org/ev-depot/charger/rapid50'), iri('https://example.org/vocab/connector'), iri('https://example.org/ev-depot/connector/ccs2'), iri('https://example.org/ev-depot/graph/catalog')).
rdf(iri('https://example.org/ev-depot/charger/rapid50'), iri('https://example.org/vocab/supply'), iri('https://example.org/ev-depot/supply/three-phase'), iri('https://example.org/ev-depot/graph/catalog')).
...
rdf(iri('https://example.org/ev-depot/charger/budget11'), iri('https://example.org/vocab/sitePowerRequirementKw'), literal('25', datatype('http://www.w3.org/2001/XMLSchema#integer')), iri('https://example.org/ev-depot/graph/catalog')).
rdf(iri('https://example.org/ev-depot/charger/budget11'), iri('https://example.org/vocab/connector'), iri('https://example.org/ev-depot/connector/ccs2'), iri('https://example.org/ev-depot/graph/catalog')).
rdf(iri('https://example.org/ev-depot/charger/budget11'), iri('https://example.org/vocab/supply'), iri('https://example.org/ev-depot/supply/three-phase'), iri('https://example.org/ev-depot/graph/catalog')).
rdf(iri('https://example.org/ev-depot/charger/legacy22'), iri('https://example.org/vocab/chargeKw'), literal('22', datatype('http://www.w3.org/2001/XMLSchema#integer')), iri('https://example.org/ev-depot/graph/catalog')).
rdf(iri('https://example.org/ev-depot/charger/legacy22'), iri('https://example.org/vocab/sitePowerRequirementKw'), literal('45', datatype('http://www.w3.org/2001/XMLSchema#integer')), iri('https://example.org/ev-depot/graph/catalog')).
...
rdf(iri('https://example.org/ev-depot/charger/legacy22'), iri('https://example.org/vocab/supply'), iri('https://example.org/ev-depot/supply/three-phase'), iri('https://example.org/ev-depot/graph/catalog')).
