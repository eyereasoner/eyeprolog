...
rdf(iri('https://example.org/operations/service/payment-api'), iri('https://example.org/vocab/dependsOn'), iri('https://example.org/operations/service/auth-service'), iri('https://example.org/operations/graph/topology')).
rdf(iri('https://example.org/operations/service/auth-service'), iri('https://example.org/vocab/dependsOn'), iri('https://example.org/operations/db/identity'), iri('https://example.org/operations/graph/topology')).
...
rdf(iri('https://example.org/operations/incident/inc-900'), iri('https://example.org/vocab/observedOn'), iri('https://example.org/operations/service/payment-api'), iri('https://example.org/operations/graph/incident')).
